...
@Composable
private fun AppLogo(modifier: Modifier = Modifier, animate: Boolean = true) {
    val transition =
...
@Composable
private fun ContinueButton(modifier: Modifier = Modifier, onClick: () -> Unit) {
    val localOnClick by rememberUpdatedState(newValue = onClick)
    Button(modifier = modifier, onClick = localOnClick) {
